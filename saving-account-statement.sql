...
when 2 then 'Withdrawl'
  ...
  IFnull(mpd.receipt_number, 0) 'Recept_no',
ifnull(concat('Ch: ', mpd.check_number,',','Re: ', mpd.receipt_number,',','B.N0: ',mpd.bank_number,',','R.NO: ',mpd.routing_code, ',','Note: ',ifnull(mn.note,' ')), '') 'Description',
